...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gridview = (GridView) view.findViewById(R.id.homerecycleview);
        getJSON();
        return  view;
    }
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
           ...
           // Toast.makeText(getContext(), ""+heroes[i], Toast.LENGTH_SHORT).show();
            Log.d(TAG, "loadIntoListView: list  "+obj.getString("sex")+obj.getString("preferSex")+obj.getString("user_id")+obj.getString("phone_number")+obj.getString("email")+obj.getString("username")+ obj.getString("sports").equals("true")+obj.getString("travel").equals("true")+ obj.getString("music").equals("true")+ obj.getString("fishing").equals("true")+obj.getString("description")+obj.getString("dateOfBirth")+obj.getString("profileImageUrl")+obj.getString("latitude")+obj.getString("longtitude"));
           if(!obj.getString("phone_number").equals(session.getmobile())){
               if(obj.getString("latitude").equals("USA")||obj.getString("latitude").equals("Bhutan")||obj.getString("latitude").equals("Bangladesh")){
...
//        gridview.setAdapter(new PersonAdapter(this,rowItems));
        Log.d(TAG, "loadIntoListView: "+clist);
        GridImageAdapter adapter = new GridImageAdapter(getContext(),R.layout.personitem,
                "", clist);
