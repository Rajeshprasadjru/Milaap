...
public class NearByAdapter extends ArrayAdapter<User> {
    ...
    public NearByAdapter(Context context, int layoutResource, String append, ArrayList<User> imgURLs,Double lati,Double longi) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
      ...
      //  holder.place.setText(" "+imgURLs.get(position).getPlace());
        holder.place.setText(" "+distance(lati,longi,imgURLs.get(position).getLatitude(),imgURLs.get(position).getLongtitude())/1000+"Km");
